# css画廊
html部分
![alt 图片预览](../img/hua.png)
```
   <div class="container">

        <div class="rotator">
            <div class="items"><img src="imgs/1.jfif" /></div>
            <div class="items"><img src="imgs/2.jfif" /></div>
            <div class="items"><img src="imgs/3.jfif" /></div>
            <div class="items"><img src="imgs/4.jfif" /></div>
            <div class="items"><img src="imgs/5.jfif" /></div>
            <div class="items"><img src="imgs/6.jfif" /></div>
            <div class="items"><img src="imgs/7.jfif" /></div>
            <div class="items"><img src="imgs/8.jfif" /></div>
            <div class="items"><img src="imgs/9.jfif" /></div>
        </div>
    </div>
